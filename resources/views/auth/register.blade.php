    ...
    <section class="flex flex-col md:flex-row h-screen items-center">
        ...
        <div
            ...
            <div class="w-full h-100">
                ...
                <h1 class="text-xl font-bold">Yacoub sign in Page</h1>
                ...
                <form class="mt-6" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mt-4">
                        ...
                        <input type="password" name="password_confirmation" id="password-confirm" placeholder="Confirm Password" minlength="6"
                            class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500
                      focus:bg-white focus:outline-none">
                ...
                <p class="mt-8">I already have an account <a href="{{ route('login') }}"
                        class="text-blue-500 hover:text-blue-700 font-semibold">
                        Login </a></p>

                <p class="text-sm text-gray-500 mt-12">&copy; {{ date('Y') }} {{ env('APP_NAME') }} - All
                    Rights Reserved.</p>
            </div>
        </div>
